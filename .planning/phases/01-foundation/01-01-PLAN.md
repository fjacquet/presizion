...
**src/lib/sizing/__tests__/formulas.test.ts** — Tests for CALC-01, CALC-02, CALC-03:
```typescript
...
**src/lib/sizing/__tests__/constraints.test.ts** — Tests for CALC-04, CALC-05, CALC-06:
```typescript
...
**src/lib/sizing/__tests__/parseNumericInput.test.ts** — Tests for parseNumericInput helper:
```typescript
...
**src/lib/display/__tests__/formulaStrings.test.ts** — Tests for CALC-07 display strings:
```typescript
...
**src/hooks/__tests__/useScenariosResults.test.ts** — Tests for useScenariosResults hook:
```typescript
